...
export const STAMINA_RECHARGE = 1.2;
export const SPRINT_DRAIN = 0.5;
export const STAWLER_MAX_SPEED = 270;
...
export const BOSS_CHASE_SPEED = 115;
export const BOSS_CHASE_RANGE = 192;
export const BOSS_PATH_INTERVAL = 0.4;
export const BOSS_ROAM_INTERVAL = 1.5;
export const BOSS_ROOM_DWELL_MAX = 4.0;
